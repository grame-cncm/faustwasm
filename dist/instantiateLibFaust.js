...
const instantiateLibFaust = async (jsFile, dataFile = jsFile.replace(/c?js$/, "data"), wasmFile = jsFile.replace(/c?js$/, "wasm")) => {
    /*
...
exports.default = instantiateLibFaust;
//# sourceMappingURL=instantiateLibFaust.js.map