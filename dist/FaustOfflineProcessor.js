...
class FaustOfflineProcessor {
    static get importObject() {
        return {
            env: {
                ...
                _isnan: Number.isNaN, _isinf: (x) => !isFinite(x),
    ...
    async init(options) {
        ...
        this.bufferSize = (options === null || options === void 0 ? void 0 : options.bufferSize) || 1024;
        this.output = new Array(this.numOut).fill(null).map(() => new Float32Array(this.bufferSize));
        this.sampleRate = (options === null || options === void 0 ? void 0 : options.sampleRate) || 48000;
...
exports.default = FaustOfflineProcessor;
